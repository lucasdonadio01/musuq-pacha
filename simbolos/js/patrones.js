/* Referencias exactas de PATRONES en Figma. La agrupación por territorio no
   cambia la atribución del FNA. Las matrices son simplificaciones para jugar,
   no calcos, emblemas históricos ni nuevos motivos generativos. */
window.Patrones = (() => {
 const refs={
  maiz:{imagen:'omaguaca-maiz.png',node:'1955:425',titulo:'Faja / Sarachumpi / Faja de maíz',lugar:'Santa Ana, Valle Grande, Jujuy. 1971',cultura:'Textil kolla',descripcion:'Fibra: lana de oveja. Hecho con: telar de cintura. Uso: vestimenta. Técnica: tejido en cara de urdimbre; urdimbres complementarias, trenzado.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 62, pp. 46-47).'},
  faja:{imagen:'omaguaca-faja.png',node:'1955:435',titulo:'Faja',lugar:'Santa Ana, Valle Grande, Jujuy. 1971',cultura:'Textil kolla',descripcion:'Fibra: lana de oveja. Hecho con: telar de cintura. Uso: vestimenta. Técnica: tejido en cara de urdimbre; tejido llano, urdimbres complementarias, trenzado.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 59, pp. 58-59).'},
  qom:{imagen:'qom-faja.png',node:'1958:437',titulo:'Faja',lugar:'Barrio Toba, Resistencia, Chaco. 1968',cultura:'Textil qom-toba',descripcion:'Fibra: lana de oveja industrial. Hecho con: telar vertical. Uso: vestimenta. Técnica: tejido llano en cara de urdimbre.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 24, pp. 112-113).'},
  yica:{imagen:'qom-yica.png',node:'1958:427',titulo:'Bolsa / Yica',lugar:'Formosa. 1970 aprox',cultura:'Textil de comunidad indígena',descripcion:'Fibra: caraguatá o chaguar. Hecho con: hilo suspendido entre estacas y aguja. Uso: recipiente y transporte. Técnica: mallas en enlazado doble interconectado.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 261, pp. 108-109).'},
  matron:{imagen:'querandi-matron.png',node:'1960:317',titulo:'Matrón',lugar:'Santa Isabel, La Pampa. 1974',cultura:'Textil ranquel',descripcion:'Fibra: lana de oveja. Hecho con: telar horizontal elevado. Uso: abrigo y adorno de cama. Técnica: tejido llano en cara de urdimbre; teñido por reserva de urdimbre.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 191, pp. 164-165).'},
  matra:{imagen:'querandi-matra.png',node:'1960:322',titulo:'Manta / Matra',lugar:'Médanos Chicos, Chalileo, La Pampa. 1968',cultura:'Textil ranquel',descripcion:'Fibra: lana de oveja. Hecho con: telar horizontal elevado. Uso: abrigo y adorno de cama. Técnica: tejido llano en cara de urdimbre; teñido por reserva de urdimbre.',fuente:'La Argentina textil, Fondo Nacional de las Artes (FNA 12, pp. 184-185).'}
 };
