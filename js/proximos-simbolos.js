window.ProximosSimbolos = (() => {
  ...
  const recetas = [
    ['omaguaca', 'Cruces en rojo', '@luna.trama', '#F2EDE5', 'om-cruce', [['om-guarda', 6, 1], ['om-pares', 8, 4], ['om-rombo', 1, 1]]],
    ...
    ['omaguaca', 'Entre guardas', '@ana.modular', '#E9D9B8', 'om-rombo', [['om-maiz', 9, 1], ['om-cruce', 2, 2]], ['#9C2447', '#F2EDE5']],
    ...
    ['omaguaca', 'Módulos en ronda', '@vale.mosaico', '#F66227', 'om-cruce', [['om-pares', 8, 5], ['om-banda', 7, 1], ['om-rombo', 2, 2]], ['#1A1A1A', '#F2EDE5']],
  ...
  const ranking = [
    ...
    ['omaguaca', 'Guarda del norte', '@trama.norte', '#8E2140', 'om-rombo', [['om-guarda', 6, 0], ['om-cruce', 1, 1], ['om-pares', 8, 4]], ['#F2EDE5', '#E3A857']],
    ['querandi', 'Rombos del sur', '@sur.creativo', '#DCE3C9', 'qu-cruce', [['qu-rombo', 7, 0], ['qu-trama', 1, 1]]],
    ['omaguaca', 'Raíz', '@raiz.andina', '#231F2A', 'om-cruce', [['om-maiz', 9, 1], ['om-rombo', 2, 2]], ['#F2C57C', '#9E6FF8']]
  ];
